            ...
            >
              {fileOperationResult.error ? (
                ...
                <div className="flex items-start space-x-2">
                  ...
                  <div>
                    <p className="text-green-700 font-medium text-sm">File uploaded successfully!</p>
              ...
              {userFiles.map(file => (
                <div key={file.id} className="flex items-center justify-between p-3 border rounded-lg">
                  <div className="flex-1">
                    ...
                    <div className="flex flex-wrap items-center gap-2 mt-1 text-sm text-gray-500">
                      ...
                      {file.isPublic && (
                        <>
                          <span>•</span>
                          <span className="px-2 py-0.5 bg-green-100 text-green-700 rounded-full text-xs">Public</span>
                        </>
                      )}
                    </div>
                  ...
                  <div className="flex gap-2 ml-4">
                    <Button onClick={() => downloadFile(file.id, file.originalName)} variant="outline" size="sm">
                      Download
                    </Button>
